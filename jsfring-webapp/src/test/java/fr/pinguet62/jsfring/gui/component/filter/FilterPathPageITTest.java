...
public class FilterPathPageITTest {
    ...
    public static Iterable<Object[]> params() {
        return Arrays.asList(new Object[][] { //
                ...
                /*
                 * // ===== String: RegexValidator { fieldStringRegex, null, new
                 * String[] {}, new BooleanBuilder() }, { fieldStringRegex,
                 * IsNullOperator.class, new String[] {},
                 * EXPRESSION_STRING.isNull() }, // validateRegex {
